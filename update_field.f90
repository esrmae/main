...
Real(mytype) :: utau,utau0,utau1,utau2,energy,esum
...
End Do
If(itravz.Eq.1) Call shift_z(umnb)
Return
...
End Do
If(itravx.Eq.1) Call shift_x(umnb)
Return
...
newx=omeg*time/kx
! FORWARD
Call dfftw_plan_dft_r2c_1d(planxu,nx,temp_1d,outfftxu,FFTW_ESTIMATE)
...
End Do
! BACKWARD
Call dfftw_plan_dft_c2r_1d(planxu,nx,outfftxu,temp_1d,FFTW_ESTIMATE)
Call dfftw_execute(planxu)
Call dfftw_destroy_plan(planxu)
!
Deallocate(outfftxu)
Return
End Subroutine shift_x
!******************************************************************************
Subroutine shift_z(temp_1d)
!******************************************************************************
Implicit none
Include "fftw3.f"
...
newz=omeg*time/kz
! FORWARD
Call dfftw_plan_dft_r2c_1d(planzu,nz,dum_1d,outfftzu,FFTW_ESTIMATE)
...
End Do
! BACKWARD
Call dfftw_plan_dft_c2r_1d(planzu,nz,outfftzu,dum_1d,FFTW_ESTIMATE)
Call dfftw_execute(planzu)
Call dfftw_destroy_plan(planzu)
!
...
!	Statistics every time step
   Call rmsfl
   If (nrank==0) Write(30,97) ii,time,dt,utau,utau1,utau2,dpdx_mean,rmsflo/height/width
!
